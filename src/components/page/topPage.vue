<template>
  <div class="w-screen h-full">
    ...
    <Button color="primary" size="lg" class="flex items-center justify-center mx-auto my-[56px]">今すぐ挑戦</Button>
    <div class="py-[104px]">
      <p
      ...
      <p class="text-[18px] font-zenMaru font-black text-center leading-[48px] mb-[72px]">日本での調査では<span
          class="bg-accent rounded-[8px] p-[4px] mx-[4px] text-white stroke-black-2">４人中３人</span>は、<br />
        騙されている可能性があり<br />
        その中の半分の人は偽の情報を知らぬ間に<br />
        拡散してしまっています。</p>

      <p class="text-[18px] font-zenMaru font-black text-center leading-[48px]">フェイクニュースは、<span
          class="bg-accent rounded-[8px] p-[4px] text-white stroke-black-2">世代とは関係なく</span><br />
        騙され、拡散されています。<br />
        だから<br />
        ちゃんとした知識を身に着け<br />
        フェイクニュースに</p>
      <p class="text-primary text-[20px] font-zenMaru font-black text-center stroke-black-2 my-[24px]">騙されない、見抜く力をつけてほしい
      </p>
    </div>
...
const cats = [
  ...
  { name: "ふろしきねこ", img: "/hurosiki.png", description: "悪いことはまだしたことのない初心者ふろしきねこ。ふろしきの中身は誰も知らない。" },
  { name: "ハットねこ", img: "/hat.png", description: "営業職で顔の広く、話しやすい気性のハットねこ。元ホントくんの相棒だったとか…" },
  { name: "はまきねこ", img: "/hamaki.png", description: "主に活動するのは夜のため目が光るはまきねこ。吸っているはまきは、セリバ・オリエ・Y。" },
  { name: "ボスねこ", img: "/boss.png", description: "できる悪いことは全てしてきたボスねこ。はまきを吸っているのはかっこいいから。" }
];
