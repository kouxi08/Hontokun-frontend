<template>
  <div class="w-screen h-screen">
    <div class="bg-detective-offices">
      ...
      <div
        class="bg-[#FFF8D6] h-[75%] mx-[24px] mt-[32px] relative p-[16px] rounded-[8px] overflow-hidden">
        <Icon
        ...
        <p class="font-zenMaru font-bold text-[15px] text-center mb-[16px]">難易度選択画面</p>
        <div
          class="h-full pb-[40px] grid grid-cols-2 md:grid-cols-4 gap-4 overflow-hidden overflow-y-scroll">
          <img
