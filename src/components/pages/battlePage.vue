<template>
  <div class="w-screen h-screen fixed">
    <div class="bg-quiz">
      ...
      <div
        v-show="!visibleQuiz"
        class="w-full h-full flex items-center whitespace-nowrap overflow-hidden">
        <p
      ...
      <div v-if="visibleQuiz" class="w-full absolute top-[88px]">
        ...
        <News
          :title="currentQuiz.news.title"
          :img="currentQuiz.news.image"
          :content="currentQuiz.news.content"
          class="pt-[32px]" />
        <div class="flex justify-between mx-[48px] pt-[32px]">
          <Icon
            ...
            width="96"
            height="96"
            class="md:w-[128px] cursor-pointer"
